package streambench.samza.workload;
...
import streambench.samza.workload.transformations.SamzaWorkloadOperation;
            ...
            workloadConfig.getSources().forEach(
                (srcname, sourceObj) -> {
                    ...
                    while(!transformations.isEmpty()) {
                        ...
                        try {
                            outStreams = SamzaWorkloadOperation.apply(name, transformation, srcStreams);
